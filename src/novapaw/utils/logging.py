# -*- coding: utf-8 -*-
"""Logging setup for NovaPaw: console output and optional file handler."""
import logging
...
_NOVAPAW_LOG_MAX_BYTES = 5 * 1024 * 1024  # 5 MiB
_NOVAPAW_LOG_BACKUP_COUNT = 3
...
def add_novapaw_file_handler(log_path: Path) -> None:
    """Add a file handler to the novapaw logger for daemon logs.
    ...
    Args:
        log_path: Path to the log file (e.g. WORKING_DIR / "novapaw.log").
    """
    ...
    if is_windows_or_linux:
        ...
        file_handler = logging.handlers.RotatingFileHandler(
            log_path,
            encoding="utf-8",
            maxBytes=_NOVAPAW_LOG_MAX_BYTES,
            backupCount=_NOVAPAW_LOG_BACKUP_COUNT,
        )
