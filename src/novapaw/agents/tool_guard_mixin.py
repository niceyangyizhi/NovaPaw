# -*- coding: utf-8 -*-
"""Tool-guard mixin for NovaPawAgent.
...
class ToolGuardMixin:
    ...
    def _init_tool_guard(self) -> None:
        ...
        from novapaw.security.tool_guard.engine import get_guard_engine
        from novapaw.app.approvals import get_approval_service
            ...
            if tool_name and engine.enabled:
                ...
                if engine.is_guarded(tool_name):
                    ...
                    if result is not None and result.findings:
                        from novapaw.security.tool_guard.utils import (
                            log_findings,
                        )
    ...
    async def _acting_auto_denied(
        ...
        from novapaw.security.tool_guard.approval import (
