...
"""Memory Manager for NovaPaw agents.
...
from novapaw.agents.tools import read_file, write_file, edit_file
from novapaw.agents.utils import _get_token_counter
...
class MemoryManager(ReMeLight):
    """Memory manager that extends ReMeLight for NovaPaw agents.
    ...
    def __init__(self, working_dir: str):
        ...
        # Initialize parent ReMeNovaPaw class
        super().__init__(
