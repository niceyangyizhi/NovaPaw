...
const DOCKER_IMAGE = "agentscope/novapaw:latest";
const MODELSCOPE_URL =
  "https://modelscope.cn/studios/fork?target=AgentScope/NovaPaw";
...
const DESKTOP_RELEASES_URL = "https://github.com/agentscope-ai/NovaPaw/releases";

const COMMANDS = {
  pip: ["pip install novapaw", "novapaw init --defaults", "novapaw app"],
  scriptMac: [
  ...
  docker: [
    ...
    `docker run -p 127.0.0.1:8088:8088 -v novapaw-data:/app/working ${DOCKER_IMAGE}`,
  ],
} as const;
