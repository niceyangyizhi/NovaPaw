...
| **大小模型协同**       | 针对 NovaPaw 工作流与敏感数据场景的本地小模型训练与微调                                                     | 进行中   |
...
NovaPaw 在开放协作中持续演进，欢迎各种形式的参与！请参考上表（尤其是标记为 **征集中** 的项）选择你感兴趣的方向，并阅读 [CONTRIBUTING](https://github.com/agentscope-ai/NovaPaw/blob/main/CONTRIBUTING.md) 了解如何开始。我们特别欢迎：

- **横向拓展** — 新频道、模型提供商、技能、MCP。
- **已有功能扩展与完善** — 展示与交互优化、下载提示、Windows 路径兼容等。

欢迎在 [GitHub Discussions](https://github.com/agentscope-ai/NovaPaw/discussions) 参与讨论、提出想法或认领任务。
